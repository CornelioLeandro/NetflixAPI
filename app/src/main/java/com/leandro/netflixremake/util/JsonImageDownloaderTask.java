...
import com.leandro.netflixremake.R;
...
public class JsonImageDownloaderTask extends AsyncTask<String, Void, Bitmap> {

    private final WeakReference<ImageView> JsonimageViewWeakReference;
    private boolean shadowEnabled;

    public JsonImageDownloaderTask(ImageView imageView) {
        this.JsonimageViewWeakReference = new WeakReference<>(imageView);
    }
    ...
    protected void onPostExecute(Bitmap bitmap) {
        ...
        ImageView imageView = JsonimageViewWeakReference.get();
